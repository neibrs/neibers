 ...
 *     "add-page" = "//neibers_category/add",
 *     "add-form" = "//neibers_category/add/{neibers_category_type}",
 *     "edit-form" = "//neibers_category/{neibers_category}/edit",
 *     "delete-form" = "//neibers_category/{neibers_category}/delete",
 *     "version-history" = "//neibers_category/{neibers_category}/revisions",
 *     "revision" = "//neibers_category/{neibers_category}/revisions/{neibers_category_revision}/view",
 *     "revision_revert" = "//neibers_category/{neibers_category}/revisions/{neibers_category_revision}/revert",
 *     "revision_delete" = "//neibers_category/{neibers_category}/revisions/{neibers_category_revision}/delete",
 *     "translation_revert" = "//neibers_category/{neibers_category}/revisions/{neibers_category_revision}/revert/{langcode}",
